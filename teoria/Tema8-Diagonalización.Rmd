...
- Dos matrices semejantes tienen la misma ecuación característica y por tanto los mimos vaps con la misma multiplicidad
...
<l class = "prop">Teorema.</l> Si la matriz $A\in\mathcal{M}_n(\mathbb{R})$ formada por vectores de un espacio vectorial $E$ tiene $n$ vaps, también tendrá $n$ veps que serán LI: $\vec{u}_1,\vec{u}_2,\dots,\vec{u}_n$

Además, como $n$ vectores LI de un espacio vectorial de dimensión finita $n$ son base, $\vec{u}_1,\vec{u}_2,\dots,\vec{u}_n$ serán una base de $E$

# Matrices diagonalizables

## Cálculo de la matriz diagonal

<l class = "prop">Teorema.</l> Una matriz $A\in\mathcal{M}_n$ es diagonalizable si, y solo si, tiene $n$ veps LI

Equivalentemente, la condición necesaria y suficiente para que una matriz sea diagonalizable es que exista una base del espacio vectorial formada por los veps de la matriz dada
...
<l class = "prop">Teorema de diagonalización.</l> La condición necesaria y suficiente para que una matriz $A$ sea diagonalizable es que para cada valor propio $\lambda_i$ su multiplicidad algebraica $n_i$ coincida con su multiplicidad geométrica $\dim(H_{\lambda_i})$ 
...
En resumen, $A$ es diagonalizable si todos los vaps pertenecen a los números reales y:
