...
<l class = "prop">Teorema del Rango.</l> Sean $E,F$ dos $\mathbb{K}$-espacios vectoriales de dimensión finita $n$ y $f:\longrightarrow F$ una aplicación lineal. Entonces, $\ker{(f)}$ e $\text{Im}(f)$ son de dimensión finita y
