...
Sea $A\in\mathcal{M}_n(\mathbb{R})$ una matriz nulipotente de índice $m$, es decir, que cumple $A^m=0$. Demuestra que $I_n-A$ es invertible y que $I_n+A+A^2+\cdots A^{m-1}$ es la inversa de $I_n-A$
...
- Demostrad que $I_3-A$ es nulipontente de índice 3
